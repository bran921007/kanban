...
<div class="h-screen flex overflow-hidden bg-white">
        ...
        <div class="fixed inset-0 flex z-40">
            ...
            <div class="relative flex-1 flex flex-col max-w-xs w-full ">
                ...
                <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="mt-5 px-2">
                        <a href="/"
                           class="group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-gray-700 bg-gray-900 focus:outline-none focus:bg-gray-700 transition ease-in-out duration-150">
                            <svg
                    ...
                    <a href="#" class="flex-shrink-0 group block">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm leading-5 font-medium text-gray-700 group-hover:text-gray-300 transition ease-in-out duration-150">
                                    View profile
                                </p>
                            </div>
                        </div>
    ...
    <div class="bg-gray-100 hidden md:flex md:flex-shrink-0">
        <div class="flex flex-col w-64 ">
            <div class="h-0 flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                ...
                <nav class="mt-5 flex-1 px-2 ">
                    ...
                    <x-desktop-nav-link route="team.index">
                        <svg
                            class="mr-3 h-6 w-6 {{Request::routeIs('team.index') ? 'text-gray-600' : 'text-gray-600'}} group-hover:text-gray-300 group-focus:text-gray-300 transition ease-in-out duration-150"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                        </svg>
                    ...
                    <a href="/logout"
                       class="mt-1 group flex items-center px-2 py-2 text-sm leading-5 font-medium text-gray-600 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition ease-in-out duration-150">
                        <svg
                            class="mr-3 h-6 w-6 text-gray-600 group-hover:text-gray-300 group-focus:text-gray-300 transition ease-in-out duration-150"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="flex-shrink-0  p-4 border-t border-gray-300">
                <a href="#" class="flex-shrink-0 w-full group block">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xs leading-4 font-medium text-gray-700 group-hover:text-gray-200 transition ease-in-out duration-150">
                                View profile
                            </p>
                        </div>
                    </div>
